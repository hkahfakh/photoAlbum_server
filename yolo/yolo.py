...
from yolo.utils.utils_xml import XmlP
...
class YOLO(object):
    _defaults = {
        ...
        # --------------------------------------------------------------------------#
        "model_path": './yolo/model_data/yolov5_s_v6.1.pth',
    ...
    def detect_image(self, image, crop=False, count=False):
        xmlp = XmlP(image.filename, image.width, image.height)
        # ---------------------------------------------------#
        #   计算输入图片的高和宽
        # ---------------------------------------------------#
        ...
        for i, c in list(enumerate(top_label)):
            ...
            xmlp.add_object(predicted_class, top, left, bottom, right, score)
